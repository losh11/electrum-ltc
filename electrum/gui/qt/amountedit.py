    ...
    def paintEvent(self, event):
        ...
        if self.base_unit:
            ...
            painter.drawText(textRect, int(
                Qt.AlignRight | Qt.AlignVCenter), self.base_unit())
...
class BTCAmountEdit(AmountEdit):
    ...
    def get_amount(self):
        ...
        amount = Decimal(max_prec_amount) / \
            pow(10, self.max_precision()-self.decimal_point())
    ...
    def setAmount(self, amount_sat):
        if amount_sat is None:
            ...
            self.setText(format_satoshis_plain(
                amount_sat, decimal_point=self.decimal_point()))
