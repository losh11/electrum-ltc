...
class TestWalletKeystoreAddressIntegrityForMainnet(ElectrumTestCase):
    ...
    def test_electrum_seed_standard(self, mock_save_db):
        ...
        self.assertEqual(
            ks.xpub, 'xpub661MyMwAqRbcFWohJWt7PHsFEJfZAvw9ZxwQoDa4SoMgsDDM1T7WK3u9E4edkC4ugRnZ8E4xDZRpk8Rnts3Nbt97dPwT52CwBdDWroaZf8U')

        w = WalletIntegrityHelper.create_standard_wallet(
            ks, config=self.config)
        self.assertEqual(w.txin_type, 'p2pkh')

        self.assertEqual(w.get_receiving_addresses()[
                         0], 'LgbiA75qdajKtdsfEXQQGwfonAQZEEEbjS')
        self.assertEqual(w.get_change_addresses()[
                         0], 'LdfcFkfXExba64HeRK1c9icSJMr6tMKyfv')
    ...
    def test_electrum_seed_segwit(self, mock_save_db):
        ...
        self.assertEqual(w.get_receiving_addresses()[
                         0], 'ltc1q3g5tmkmlvxryhh843v4dz026avatc0zz8xd49e')
        self.assertEqual(w.get_change_addresses()[
                         0], 'ltc1qdy94n2q5qcp0kg7v9yzwe6wvfkhnvyzjazfzj3')
    ...
    def test_electrum_seed_segwit_passphrase(self, mock_save_db):
        ...
        self.assertEqual(w.get_receiving_addresses()[
                         0], 'ltc1qx94dutas7ysn2my645cyttujrms5d9p564qe9t')
        self.assertEqual(w.get_change_addresses()[
                         0], 'ltc1qcywwsy87sdp8vz5rfjh3sxdv6rt95kujfu64lc')
    ...
    def test_electrum_seed_old(self, mock_save_db):
        ...
        self.assertEqual(w.get_receiving_addresses()[
                         0], 'LZXBVPSYn3bfFfibvUm9K8h4BddGhUE4Fe')
        self.assertEqual(w.get_change_addresses()[
                         0], 'LdeTQ2avMuXcwvpJfMpPwFPgz5F3Fnbsdu')

    @mock.patch.object(wallet.Abstract_Wallet, 'save_db')
    def test_bip39_seed_bip44_standard(self, mock_save_db):
        seed_words = 'treat dwarf wealth gasp brass outside high rent blood crowd make initial'
        self.assertEqual(keystore.bip39_is_checksum_valid(
            seed_words), (True, True))
        ...
        self.assertEqual(w.get_receiving_addresses()[
                         0], 'LQx4V43sdoTgiRt3TkBncbSBBMijtP3jg3')
        self.assertEqual(w.get_change_addresses()[
                         0], 'LaV2rhxLkq48nJoTWLp19f4pcnZLtJeLoB')
    ...
    def test_bip39_seed_bip44_standard_passphrase(self, mock_save_db):
        ...
        self.assertEqual(w.get_receiving_addresses()[
                         0], 'LZM5wF6QG1wGRvWhS2sgnHUT5Bxr9CJYdR')
        self.assertEqual(w.get_change_addresses()[
                         0], 'LbHMUEAW7eeMKHS4LdJ9MfZmsSiQeoRyng')
    ...
    def test_bip39_seed_bip49_p2sh_segwit(self, mock_save_db):
        ...
        self.assertEqual(w.get_receiving_addresses()[
                         0], 'MC1qiM3LvsbB3WdgFf9q3tzK9fmLrX1SQs')
        self.assertEqual(w.get_change_addresses()[
                         0], 'MRnKmWLg8T5jPEj8TktCyfWv4FPqyFBS3V')
    ...
    def test_bip39_seed_bip84_native_segwit(self, mock_save_db):
        ...
        self.assertEqual(w.get_receiving_addresses()[
                         0], 'ltc1qcr8te4kr609gcawutmrza0j4xv80jy8z4nqduv')
        self.assertEqual(w.get_change_addresses()[
                         0], 'ltc1q8c6fshw2dlwun7ekn9qwf37cu2rn755u9ym7p0')
    ...
    def test_electrum_multisig_seed_standard(self, mock_save_db):
        ...
        self.assertEqual(
            ks1.xprv, 'xprv9s21ZrQH143K3t9vo23J3hajRbzvkRLJ6Y1zFrUFAfU3t8oooMPfb7f87cn5KntgqZs5nipZkCiBFo5ZtaSD2eDo7j7CMuFV8Zu6GYLTpY6')
        self.assertEqual(
        ...
        self.assertEqual(w.get_receiving_addresses()[
                         0], 'M8wrMJA8deEQuJXhXYa6nrJPBi7yiLnCN5')
        self.assertEqual(w.get_change_addresses()[
                         0], 'MCjfF7hpoc3mbD1DBEqqJv1scPJJDhtoMG')
    ...
    def test_electrum_multisig_seed_segwit(self, mock_save_db):
        ...
        self.assertEqual(w.get_receiving_addresses()[
                         0], 'ltc1qvzezdcv6vs5h45ugkavp896e0nde5c5lg5h0fwe2xyfhnpkxq6gqa9a79a')
        self.assertEqual(w.get_change_addresses()[
                         0], 'ltc1qxqf840dqswcmu7a8v82fj6ej0msx08flvuy6kngr7axstjcaq6usxndfdg')
    ...
    def test_bip39_multisig_seed_bip45_standard(self, mock_save_db):
        ...
        self.assertEqual(w.get_receiving_addresses()[
                         0], 'MQbbhvCgqcowyoHsoEdZkvMENhhvktToCi')
        self.assertEqual(w.get_change_addresses()[
                         0], 'MMV7XoNeRLdTcwqYBq9e6fDtG9E9uHciwz')
    ...
    def test_bip39_multisig_seed_p2sh_segwit(self, mock_save_db):
        ...
        self.assertEqual(w.get_receiving_addresses()[
                         0], 'MBYnVwVNdKM5EK7uzBCSAMU5iJa3ATHxCK')
        self.assertEqual(w.get_change_addresses()[
                         0], 'MFdrC72fZDa7aTMo5gi7XSyeeiA3P9VtUM')
    ...
    def test_bip32_extended_version_bytes(self, mock_save_db):
        ...
        self.assertEqual(
            '033a05ec7ae9a9833b0696eb285a762f17379fa208b3dc28df1c501cf84fe415d0', ks.derive_pubkey(0, 0).hex())
        self.assertEqual(
            '02bf27f41683d84183e4e930e66d64fc8af5508b4b5bf3c473c505e4dbddaeed80', ks.derive_pubkey(1, 0).hex())

        ks = create_keystore_from_bip32seed(xtype='standard')  # p2pkh
        w = WalletIntegrityHelper.create_standard_wallet(
            ks, config=self.config)
        self.assertEqual(
            ks.xprv, 'xprv9s21ZrQH143K3nyWMZVjzGL4KKAE1zahmhTHuV5pdw4eK3o3igC5QywgQG7UTRe6TGBniPDpPFWzXMeMUFbBj8uYsfXGjyMmF54wdNt8QBm')
        self.assertEqual(
            ks.xpub, 'xpub661MyMwAqRbcGH3yTb2kMQGnsLziRTJZ8vNthsVSCGbdBr8CGDWKxnGAFYgyKTzBtwvPPmfVAWJuFmxRXjSbUTg87wDkWQ5GmzpfUcN9t8Z')
        self.assertEqual(w.get_receiving_addresses()[
                         0], 'LTtTVhtMvLYJWaoTiWqQ5w2jwnLL6Rra9S')
        self.assertEqual(w.get_change_addresses()[
                         0], 'LYTUNqss6W2gonLUojLPN6znCrSxkzEmkb')
        ...
        self.assertEqual(
            ks.xpub, 'ypub6QqdH2c5z7967aF6HwpNZVNJ3K9AN5J442u7VGPKaGyWEwwRWsftaqvJGkeZKNe7Jb3C9FG3dAfT94ZzFRrcGhMizGvB6Jtm3itJsEFhxMC')
        self.assertEqual(w.get_receiving_addresses()[
                         0], 'MAeJky6ECCKzzCyLf1pajZCxFFd4fEVs16')
        self.assertEqual(w.get_change_addresses()[
                         0], 'MF7vnDyYc1HhEqC83zKCjPwYKTipPQkVBo')

        ks = create_keystore_from_bip32seed(xtype='p2wpkh')
        w = WalletIntegrityHelper.create_standard_wallet(
            ks, config=self.config)
        self.assertEqual(
            ks.xprv, 'zprvAWgYBBk7JR8GkPMk2H4zQSX4fFT7uEZhbvVjUGsbPwpQRFRWDzXCf7FxSg2eTEwwGYRQDLQwJaE6HvsUueRDKcGkcLv7unzjnXCEQVWhrF9')
        self.assertEqual(
            ks.xpub, 'zpub6jftahH18ngZxsSD8JbzmaToDHHcJhHYy9RLGfHCxHMPJ3kemXqTCuaSHxc9KHJ2iE9ztirc5q212MBYy8Gd4w3KrccbgDiFKSwxFpYKEH6')
        self.assertEqual(w.get_receiving_addresses()[
                         0], 'ltc1qtuynwzd0d6wptvyqmc6ehkm70zcamxpsncccvf')
        self.assertEqual(w.get_change_addresses()[
                         0], 'ltc1qjy5zunxh6hjysele86qqywfa437z4xwmm96rkx')
        ...
        self.assertEqual(
            ks.xpub, 'xpub661MyMwAqRbcGH3yTb2kMQGnsLziRTJZ8vNthsVSCGbdBr8CGDWKxnGAFYgyKTzBtwvPPmfVAWJuFmxRXjSbUTg87wDkWQ5GmzpfUcN9t8Z')
        self.assertEqual(w.get_receiving_addresses()[
                         0], 'MMGw51usjhyCm1CjoMNMrmdx1Ld9oJsKgE')
        self.assertEqual(w.get_change_addresses()[
                         0], 'MULtECgjv7Li2t3zGwyoTD8SgrCDSqzVmi')
        ...
        self.assertEqual(w.get_receiving_addresses()[
                         0], 'MSDLGDk8PPAeqiguxnqvLQJ6taHiCKq6Cd')
        self.assertEqual(w.get_change_addresses()[
                         0], 'MURQvUyTUag1D1hbpnUjeB7nCmGUCdw8p4')
        ...
        self.assertEqual(w.get_receiving_addresses()[
                         0], 'ltc1q84x0yrztvcjg88qef4d6978zccxulcmc9y88xcg4ghjdau999x7qaxz66u')
        self.assertEqual(w.get_change_addresses()[
                         0], 'ltc1q0fj5mra96hhnum80kllklc52zqn6kppt3hyzr49yhr3ecr42z3tsqjxpj4')
    ...
    def test_slip39_basic_3of6_bip44_standard(self, mock_save_db):
        ...
        self.assertEqual(w.get_receiving_addresses()[
                         0], 'Lh2iaNnCsFQWCQ64SRm3iWqZ4WoN2FgSqU')
        self.assertEqual(w.get_change_addresses()[
                         0], 'LVA2D2qhFdULhV3j1XdGvxrw6XCZENgXrf')
    ...
    def test_slip39_basic_2of5_bip49_p2sh_segwit(self, mock_save_db):
        ...
        self.assertEqual(
            ks.xprv, 'yprvAK7DoEDitppjkdf6LrveZUBjB1SFQ54mTy8pqyb1wDyTjNkzNnFC1PEeGyBLfEAjxv3RmtusmBco7LF5DPxtV94mP7qa8t4dP4mmiDrnZF2')
        self.assertEqual(
            ks.xpub, 'ypub6Y6aCjkcjCP2y7jZStTevc8Tj3GjoXncqC4ReMzdVZWScB68vKZSZBZ88ENvuPUXXBBR58JXkuz1UrwLnCFvnFTUEpzu5yQabeYBRyd7Edf')
        ...
        self.assertEqual(w.get_receiving_addresses()[
                         0], 'MNQpggvUSxM4VhER4jmrDvwLfbG7EvMwwE')
        self.assertEqual(w.get_change_addresses()[
                         0], 'MMi4wK7P4yS3ND3X2jFWfAQ3dVyaU4sfXC')
    ...
    def test_slip39_groups_128bit_bip84_native_segwit(self, mock_save_db):
        ...
        self.assertEqual(
            ks.xprv, 'zprvAdskBk5s8FxC4hq9PVU1nSRRzotSzUy9vTwv5hscqr3ANM52mtJJT5cdfHTJnfd2cPFKWXpm4WhB9ruQCEC8KWkSeziMEZjbheNp4xUUTTG')
        self.assertEqual(
            ks.xpub, 'zpub6rs6bFckxdWVHBucVX129aNAYqiwPwh1HgsWt6HEQBa9F9QBKRcYzsw7WZR7rPSCWKmRVTUaEgrGrHStx2LSTpbgAEerbnrh4XxkRXbUUZF')
        ...
        self.assertEqual(w.get_receiving_addresses()[
                         0], 'ltc1qaggygkqgqjjpt58zrmhvjz5m9dj8mjsh2n99sv')
        self.assertEqual(w.get_change_addresses()[
                         0], 'ltc1q8l6hcvlczu4mtjcnlwhczw7vdxnvwccpkrtukj')
    ...
    def test_slip39_groups_256bit_bip49_p2sh_segwit(self, mock_save_db):
        ...
        self.assertEqual(
            ks.xprv, 'yprvAHiJ72E8kJU1XQ2adZcUv8Buffr48bik1F3EHCSDDafScwLdfJ5oDgENm1cAAxNPeXMCBxmm7rmyoKua5LfjnrmgxqP5sYtAVDYngxF2zsB')
        self.assertEqual(
            ks.xpub, 'ypub6WheWXm2ag2Jjt73jb9VHG8eDhgYY4SbNTxq5aqpmvCRVjfnCqQ3mUYrcGiBR5qvbhJap5hjSiN2eoXBFLGuipWLRAgf11bRThSJLoGrBag')
        ...
        self.assertEqual(w.get_receiving_addresses()[
                         0], 'MN1z4WGCEobkCYzRYma8icvbyb1iQvq6yM')
        self.assertEqual(w.get_change_addresses()[
                         0], 'M974mebJcTf6he6mAKWAHwSTz8gbBK9hKb')
...
class TestWalletKeystoreAddressIntegrityForTestnet(TestCaseForTestnet):
    ...
    def test_bip39_multisig_seed_p2sh_segwit_testnet(self, mock_save_db):
        ...
        self.assertEqual(w.get_receiving_addresses()[
                         0], 'QUERagKWpsSWvprWNivNrVfAEjPbK3GA2c')
        self.assertEqual(w.get_change_addresses()[
                         0], 'QjAv49kqZeSEhpo12vgZFzrB6S8RMCegug')
    ...
    def test_bip32_extended_version_bytes(self, mock_save_db):
        ...
        self.assertEqual(w.get_receiving_addresses()[
                         0], 'mpBTXYfWehjW2tavFwpUdqBJbZZkup13k2')
        self.assertEqual(w.get_change_addresses()[
                         0], 'mtkUQgf1psDtL67wMAKTv19LrdgPWy6GDQ')
        ...
        self.assertEqual(w.get_receiving_addresses()[
                         0], 'QPM8dqUXse31Xg62rNV8cZPFHHgcLu6vLw')
        self.assertEqual(w.get_change_addresses()[
                         0], 'QTpkf6MrHSzhnJJpFLykcQ7qMVnN9LUuCe')
        ...
        self.assertEqual(
            ks.xpub, 'vpub5SLqN2bLY4WeZgfjnsTVwE5nXQhpYDKZJhLT95hfSFqs5eVjkuBCiewtD8moKegM5fgmtpUNFBboVCjJ6LcZszJvPFpuLaSJEYhNhUAnrCS')
        self.assertEqual(w.get_receiving_addresses()[
                         0], 'tltc1qtuynwzd0d6wptvyqmc6ehkm70zcamxpsy2m3lr')
        self.assertEqual(w.get_change_addresses()[
                         0], 'tltc1qjy5zunxh6hjysele86qqywfa437z4xwmvhe29v')
        ...
        self.assertEqual(
            ks.xpub, 'tpubD6NzVbkrYhZ4Y5Epun1qZKcACU6NQqocgYyC4RYaYBMWw8nuLSMR7DvzVamkqxwRgrTJ1MBMhc8wwxT2vbHqMu8RBXy4BvjWMxR5EdZroxE')
        self.assertEqual(w.get_receiving_addresses()[
                         0], 'QZykwtJBR9gDJUKRzi2ujmpF3NghQtKC4x')
        self.assertEqual(w.get_change_addresses()[
                         0], 'Qh3i7553bZ3iaMAgUJeMLDJjitFm8zYwhv')
        ...
        self.assertEqual(w.get_receiving_addresses()[
                         0], 'QevA968S4psfPBocA9WUDQUPvcMFwq7ZdA')
        self.assertEqual(w.get_change_addresses()[
                         0], 'Qh8EoMMmA2P1kUpJ299HXBJ5EoL1xrrTLT')

        ks = create_keystore_from_bip32seed(xtype='p2wsh')
        w = WalletIntegrityHelper.create_multisig_wallet(
            [ks], '1of1', config=self.config)
        self.assertEqual(
            ks.xprv, 'Vprv16YtLrHXxePM6noKqtFtMtmUgBE9bEpF3fPLmpvuPksssLostujtdHBwqhEeVuzESz22UY8hyPx9ed684SQpCmUKSVhpxPFbvVNY7qnviNR')
        self.assertEqual(
            ks.xpub, 'Vpub5dEvVGKn7251zFq7jXvUmJRbFCk5ka19cxz84LyCp2gGhq4eXJZUomop1qjGt5uFK8kkmQUV8PzJcNM4PZmX2URbDiwJjyuJ8GyFHRrEmmG')
        self.assertEqual(w.get_receiving_addresses()[
                         0], 'tltc1q84x0yrztvcjg88qef4d6978zccxulcmc9y88xcg4ghjdau999x7qkfxy9f')
        self.assertEqual(w.get_change_addresses()[
                         0], 'tltc1q0fj5mra96hhnum80kllklc52zqn6kppt3hyzr49yhr3ecr42z3tstazldq')
...
class TestWalletSending(TestCaseForTestnet):
    ...
    def test_sending_between_p2wpkh_and_compressed_p2pkh(self, mock_save_db):
        ...
        tx = wallet1.mktx(outputs=outputs, password=None,
                          fee=5000, tx_version=1)
        ...
        self.assertTrue(wallet1.is_mine(
            wallet1.get_txin_address(tx_copy.inputs()[0])))
        ...
        tx = wallet2.mktx(outputs=outputs, password=None,
                          fee=5000, tx_version=1)
        ...
        tx_copy = tx_from_any(tx.serialize())
        self.assertTrue(wallet2.is_mine(
            wallet2.get_txin_address(tx_copy.inputs()[0])))
        ...
        # wallet level checks
        self.assertEqual((0, funding_output_value - 250000 -
                         5000 + 100000, 0), wallet1.get_balance())
    ...
    def test_sending_between_p2sh_2of3_and_uncompressed_p2pkh(self, mock_save_db):
        wallet1a = WalletIntegrityHelper.create_multisig_wallet(
            [
                keystore.from_seed(
                    'blast uniform dragon fiscal ensure vast young utility dinosaur abandon rookie sure', '', True),
                keystore.from_xpub(
        ...
        wallet1b = WalletIntegrityHelper.create_multisig_wallet(
            [
                keystore.from_seed(
                    'cycle rocket west magnet parrot shuffle foot correct salt library feed song', '', True),
                keystore.from_xpub(
                    'tpubD6NzVbkrYhZ4YTPEgwk4zzr8wyo7pXGmbbVUnfYNtx6SgAMF5q3LN3Kch58P9hxGNsTmP7Dn49nnrmpE6upoRb1Xojg12FGLuLHkVpVtS44'),
                keystore.from_xpub(
        ...
        wallet1a.receive_tx_callback(
            funding_txid, funding_tx, TX_HEIGHT_UNCONFIRMED)

        # wallet1 -> wallet2
        outputs = [PartialTxOutput.from_address_and_value(
            wallet2.get_receiving_address(), 370000)]
        tx = wallet1a.mktx(outputs=outputs, password=None,
                           fee=5000, tx_version=1)
        ...
        tx_copy = tx_from_any(tx.serialize())
        self.assertTrue(wallet1a.is_mine(
            wallet1a.get_txin_address(tx_copy.inputs()[0])))
        ...
        # wallet level checks
        self.assertEqual((0, funding_output_value - 370000 -
                         5000 + 100000, 0), wallet1a.get_balance())
    ...
    def test_sending_between_p2wsh_2of3_and_p2wsh_p2sh_2of2(self, mock_save_db):
        wallet1a = WalletIntegrityHelper.create_multisig_wallet(
            [
                keystore.from_seed(
                    'bitter grass shiver impose acquire brush forget axis eager alone wine silver', '', True),
                keystore.from_xpub(
        ...
        wallet1b = WalletIntegrityHelper.create_multisig_wallet(
            [
                keystore.from_seed(
                    'snow nest raise royal more walk demise rotate smooth spirit canyon gun', '', True),
                keystore.from_xpub(
                    'Vpub5fjkKyYnvSS4wBuakWTkNvZDaBM2vQ1MeXWq368VJHNr2eT8efqhpmZ6UUkb7s2dwCXv2Vuggjdhk4vZVyiAQTwUftvff73XcUGq2NQmWra'),
                keystore.from_xpub(
        ...
        outputs = [PartialTxOutput.from_address_and_value(
            wallet1a.get_receiving_address(), 100000)]
        tx = wallet2a.mktx(outputs=outputs, password=None,
                           fee=5000, tx_version=1)
        txid = tx.txid()
        partial_tx = tx.serialize_as_bytes().hex()
        ...
        tx_copy = tx_from_any(tx.serialize())
        self.assertTrue(wallet2a.is_mine(
            wallet2a.get_txin_address(tx_copy.inputs()[0])))
        ...
        # wallet level checks
        self.assertEqual((0, funding_output_value - 165000 -
                         5000 + 100000, 0), wallet1a.get_balance())
    ...
    def test_sending_between_p2sh_1of2_and_p2wpkh_p2sh(self, mock_save_db):
        wallet1a = WalletIntegrityHelper.create_multisig_wallet(
            [
                keystore.from_seed(
                    'phone guilt ancient scan defy gasp off rotate approve ill word exchange', '', True),
                keystore.from_xpub(
        ...
        # wallet level checks
        self.assertEqual((0, funding_output_value - 1000000 -
                         5000 + 300000, 0), wallet1a.get_balance())
        self.assertEqual((0, 1000000 - 5000 - 300000, 0),
                         wallet2.get_balance())
    ...
    def _bump_fee_p2pkh_when_there_is_a_change_address(self, *, simulate_moving_txs, config):
        ...
        # create tx
        outputs = [PartialTxOutput.from_address_and_value(
            'QUrDUN7qA7VNHd8TnrV94qFKXU6P9djYPn', 2500000)]
        ...
        self.assertEqual(1, len(tx.inputs()))
        tx_copy = tx_from_any(tx.serialize())
        self.assertTrue(wallet.is_mine(
            wallet.get_txin_address(tx_copy.inputs()[0])))
        ...
        self.assertEqual((0, funding_output_value - 2500000 -
                         5000, 0), wallet.get_balance())
    ...
    def _bump_fee_p2pkh_when_there_are_two_ismine_outs_one_change_one_recv(self, *, simulate_moving_txs, config):
        ...
        wallet.receive_tx_callback(
            orig_rbf_txid, orig_rbf_tx, TX_HEIGHT_UNCONFIRMED)

        # bump tx
        tx = wallet.bump_fee(tx=tx_from_any(
            orig_rbf_tx.serialize()), new_fee_rate=200)
        self.assertTrue(not any(
            [txin for txin in tx.inputs() if txin.prevout.txid.hex() == orig_rbf_txid]))
        tx.locktime = 1898260
        tx.version = 2
        if simulate_moving_txs:
            partial_tx = tx.serialize_as_bytes().hex()
    ...
    def test_cpfp_p2pkh(self, mock_save_db):
        ...
        wallet.receive_tx_callback(tx.txid(), tx, TX_HEIGHT_UNCONFIRMED)
        self.assertEqual((0, funding_output_value - 50000, 0),
                         wallet.get_balance())
    ...
    def _bump_fee_when_not_all_inputs_are_ismine_subcase_some_outputs_are_ismine_but_not_all(self, *, simulate_moving_txs, config):
        ...
        # bump tx
        tx = wallet.bump_fee(tx=tx_from_any(
            orig_rbf_tx.serialize()), new_fee_rate=70)
        tx.locktime = 1898268
        tx.version = 2
        if simulate_moving_txs:
            partial_tx = tx.serialize_as_bytes().hex()
    ...
    def _bump_fee_when_not_all_inputs_are_ismine_subcase_all_outputs_are_ismine(self, *, simulate_moving_txs, config):
        ...
        # bump tx
        tx = wallet.bump_fee(tx=tx_from_any(
            orig_rbf_tx.serialize()), new_fee_rate=50)
        tx.locktime = 1898273
        tx.version = 2
        if simulate_moving_txs:
            partial_tx = tx.serialize_as_bytes().hex()
    ...
    def _bump_fee_p2wpkh_when_there_is_only_a_single_output_and_that_is_a_change_address(self, *, simulate_moving_txs, config):
        ...
        # create tx
        outputs = [PartialTxOutput.from_address_and_value(
            'tltc1q7rl9cxr85962ztnsze089zs8ycv52hk4gpn946', '!')]
        coins = wallet.get_spendable_coins(domain=None)
        tx = wallet.make_unsigned_transaction(
            coins=coins, outputs=outputs, fee=5000)
        tx.set_rbf(True)
        ...
        wallet.receive_tx_callback(tx.txid(), tx, TX_HEIGHT_UNCONFIRMED)
        self.assertEqual((0, funding_output_value - 5000, 0),
                         wallet.get_balance())
    ...
    def _bump_fee_when_user_sends_max(self, *, simulate_moving_txs, config):
        ...
        # create tx
        outputs = [PartialTxOutput.from_address_and_value(
            'QUrDUN7qA7VNHd8TnrV94qFKXU6P9djYPn', '!')]
        coins = wallet.get_spendable_coins(domain=None)
        tx = wallet.make_unsigned_transaction(
            coins=coins, outputs=outputs, fee=5000)
        tx.set_rbf(True)
    ...
    def _bump_fee_when_new_inputs_need_to_be_added(self, *, simulate_moving_txs, config):
        ...
        wallet.receive_tx_callback(
            funding_txid1, funding_tx1, TX_HEIGHT_UNCONFIRMED)
        ...
        wallet.receive_tx_callback(
            funding_txid2, funding_tx2, TX_HEIGHT_UNCONFIRMED)
    ...
    def _rbf_batching(self, *, simulate_moving_txs, config):
        ...
        # create tx
        outputs = [PartialTxOutput.from_address_and_value(
            'QUrDUN7qA7VNHd8TnrV94qFKXU6P9djYPn', 2_500_000)]
        coins = wallet.get_spendable_coins(domain=None)
        tx = wallet.make_unsigned_transaction(
            coins=coins, outputs=outputs, fee=5000)
        tx.set_rbf(True)
        ...
        outputs = [PartialTxOutput.from_address_and_value(
            'tltc1qy6xmdj96v5dzt3j08hgc05yk3kltqsnmhapynd', 2_500_000)]
        coins = wallet.get_spendable_coins(domain=None)
        tx = wallet.make_unsigned_transaction(
            coins=coins, outputs=outputs, fee=20000)
        tx.set_rbf(True)
        tx.locktime = 1325499
        tx.version = 1
        if simulate_moving_txs:
        ...
        outputs = [PartialTxOutput.from_address_and_value(
            'Qfrhin74wgaQS1HWtQhKvr9cEKLFGRpYV9', 6_000_000)]
        coins = wallet.get_spendable_coins(domain=None)
        tx = wallet.make_unsigned_transaction(
            coins=coins, outputs=outputs, fee=100_000)
        tx.set_rbf(True)
        tx.locktime = 1325499
        tx.version = 1
        if simulate_moving_txs:
    ...
    def test_sweep_p2pk(self):
        ...
        sweep_coro = sweep(privkeys, network=network, config=self.config,
                           to_address=dest_addr, fee=5000, locktime=1325785, tx_version=1)
    ...
    def test_coinjoin_between_two_p2wpkh_electrum_seeds(self, mock_save_db):
        ...
        wallet2.receive_tx_callback(
            funding_txid, funding_tx, TX_HEIGHT_UNCONFIRMED)

        # wallet1 creates tx1, with output back to himself
        outputs = [PartialTxOutput.from_address_and_value(
            "tltc1qhye4wfp26kn0l7ynpn5a4hvt539xc3zfkmuymc", 10_000_000)]
        tx1 = wallet1.mktx(outputs=outputs, fee=5000,
                           tx_version=2, rbf=True, sign=False)
        ...
        outputs = [PartialTxOutput.from_address_and_value(
            "tltc1qufnj5k2rrsnpjq7fg6d2pq3q9um6skdya34syj", 10_000_000)]
        tx2 = wallet2.mktx(outputs=outputs, fee=5000,
                           tx_version=2, rbf=True, sign=False)
    ...
    def test_standard_wallet_cannot_sign_multisig_input_even_if_cosigner(self, mock_save_db):
        ...
        wallet_2of2.receive_tx_callback(
            funding_txid, funding_tx, TX_HEIGHT_UNCONFIRMED)

        # create tx
        outputs = [PartialTxOutput.from_address_and_value(
            'tltc1qfrlx5pza9vmez6vpx7swt8yp0nmgz3qa86sgvq', 100_000)]
        ...
        self.assertEqual(
            'tltc1qxq5crk6yadw66rdt8xr3xj5ctvmq4c3z0fl85yx0ar8l6ga6ehysfvlnuf', tx.inputs()[0].address)
        self.assertEqual('tltc1qfrlx5pza9vmez6vpx7swt8yp0nmgz3qa86sgvq',
                         tx.outputs()[0].address)
        self.assertEqual(
            'tltc1qadpg5z77egkpkde34mdcrsz3s3tgwk5ew4w3wlfqf4j3dk8kkvrswgd6vs', tx.outputs()[1].address)
        ...
        self.assertFalse(any([wallet_frost.is_mine(txin.address)
                         for txin in tx.inputs()]))
        self.assertFalse(any([wallet_frost.is_mine(txout.address)
    ...
    def _dscancel_when_all_outputs_are_ismine(self, *, simulate_moving_txs, config):
        ...
        # create tx
        outputs = [PartialTxOutput.from_address_and_value(
            'miFLSDZBXUo4on8PGhTRTAufUn4mP61uoH', '!')]
        coins = wallet.get_spendable_coins(domain=None)
        tx = wallet.make_unsigned_transaction(
            coins=coins, outputs=outputs, fee=5000)
        tx.set_rbf(True)
    ...
    def _dscancel_when_not_all_inputs_are_ismine(self, *, simulate_moving_txs, config):
        ...
        # bump tx
        tx = wallet.dscancel(tx=tx_from_any(
            orig_rbf_tx.serialize()), new_fee_rate=70)
        tx.locktime = 1898278
        tx.version = 2
        if simulate_moving_txs:
    ...
    def test_wallet_history_chain_of_unsigned_transactions(self, mock_save_db):
        ...
        # create tx1
        outputs = [PartialTxOutput.from_address_and_value(
            'tltc1qsfcddwf7yytl62e3catwv8hpl2hs9e363z67kk', 100000)]
        coins = wallet.get_spendable_coins(domain=None)
        tx = wallet.make_unsigned_transaction(
            coins=coins, outputs=outputs, fee=190)
        tx.set_rbf(True)
        tx.locktime = 1938861
        tx.version = 2
        ...
        outputs = [PartialTxOutput.from_address_and_value(
            'tltc1qq0lm9esmq6pfjc3jls7v6twy93lnqcs8dxa48c', '!')]
        coins = wallet.get_spendable_coins(domain=None)
        tx = wallet.make_unsigned_transaction(
            coins=coins, outputs=outputs, fee=5000)
        tx.set_rbf(True)
    ...
    def test_wallet_does_not_create_zero_input_tx(self, mock_save_db):
        ...
        with self.subTest(msg="no coins to use as inputs, max output value, zero fee"):
            outputs = [PartialTxOutput.from_address_and_value(
                'tltc1qsfcddwf7yytl62e3catwv8hpl2hs9e363z67kk', '!')]
            coins = wallet.get_spendable_coins(domain=None)
            with self.assertRaises(NotEnoughFunds):
                tx = wallet.make_unsigned_transaction(
                    coins=coins, outputs=outputs, fee=0)
        ...
        with self.subTest(msg="funded wallet, zero output value, zero fee"):
            outputs = [PartialTxOutput.from_address_and_value(
                'tltc1qsfcddwf7yytl62e3catwv8hpl2hs9e363z67kk', 0)]
            coins = wallet.get_spendable_coins(domain=None)
            tx = wallet.make_unsigned_transaction(
                coins=coins, outputs=outputs, fee=0)
            self.assertEqual(1, len(tx.inputs()))
    ...
    def test_imported_wallet_usechange_off(self, mock_save_db):
        ...
        outputs = [PartialTxOutput.from_address_and_value(
            'tltc1qq4pypzwxf5uanfyckmsu3ejxxf6rrvjqplqrp9', 49646)]
        coins = wallet.get_spendable_coins(domain=None)
        tx = wallet.make_unsigned_transaction(
            coins=coins, outputs=outputs, fee=1000)
        tx.set_rbf(True)
        tx.locktime = 2004420
        tx.version = 2
        ...
        self.assertEqual(2, len(tx.outputs()))
        self.assertTrue(tx.output_value_for_address(
            "tltc1q0fj7pxa3m2q2hlr964zn3z3wvx4t03epdp2d8d") > 0)
        self.assertEqual(49646, tx.output_value_for_address(
            "tltc1qq4pypzwxf5uanfyckmsu3ejxxf6rrvjqplqrp9"))
    ...
    def test_imported_wallet_usechange_on(self, mock_save_db):
        ...
        self.assertEqual(2, len(tx.outputs()))
        self.assertTrue(tx.output_value_for_address(
            "tltc1qetcgdwuzlpdnt5fmzxxdpczjhadz06cy2ff439") > 0)
        self.assertEqual(49646, tx.output_value_for_address(
            "tltc1qq4pypzwxf5uanfyckmsu3ejxxf6rrvjqplqrp9"))
...
class TestWalletOfflineSigning(TestCaseForTestnet):
    ...
    def test_sending_offline_old_electrum_seed_online_mpk(self, mock_save_db):
        wallet_offline = WalletIntegrityHelper.create_standard_wallet(
            keystore.from_seed(
                'alone body father children lead goodbye phone twist exist grass kick join', '', False),
            gap_limit=4,
            config=self.config
        )
        ...
        # create unsigned tx
        outputs = [PartialTxOutput.from_address_and_value(
            'tltc1qyw3c0rvn6kk2c688y3dygvckn57525y8emy4p5', 2500000)]
        ...
        self.assertTrue(wallet_online.is_mine(
            wallet_online.get_txin_address(tx_copy.inputs()[0])))
    ...
    def test_sending_offline_xprv_online_xpub_p2pkh(self, mock_save_db):
        ...
        # create unsigned tx
        outputs = [PartialTxOutput.from_address_and_value(
            'tltc1qp0mv2sxsyxxfj5gl0332f9uyez93su9cszcqyh', 2500000)]
        tx = wallet_online.mktx(outputs=outputs, password=None, fee=5000)
        tx.set_rbf(True)
        tx.locktime = 1325340
        tx.version = 1
    ...
    @mock.patch.object(wallet.Abstract_Wallet, 'save_db')
    # compressed pubkey
    def test_sending_offline_wif_online_addr_p2pkh(self, mock_save_db):
        ...
        # create unsigned tx
        outputs = [PartialTxOutput.from_address_and_value(
            'tltc1quk7ahlhr3qmjndy0uvu9y9hxfesrtahtj48k8j', 2500000)]
        tx = wallet_online.mktx(outputs=outputs, password=None, fee=5000)
        tx.set_rbf(True)
        tx.locktime = 1325340
        tx.version = 1
    ...
    def test_sending_offline_wif_online_addr_p2wpkh(self, mock_save_db):
        ...
        wallet_online.import_address(
            'tltc1qm2eh4787lwanrzr6pf0ekf5c7jnmghm2ad526v')
    ...
    @mock.patch.object(wallet.Abstract_Wallet, 'save_db')
    # compressed pubkey
    def test_sending_offline_xprv_online_addr_p2pkh(self, mock_save_db):
        wallet_offline = WalletIntegrityHelper.create_standard_wallet(
            # bip39: "qwe", der: m/44'/1'/0'
            keystore.from_xprv(
                'tprv8gfKwjuAaqtHgqxMh1tosAQ28XvBMkcY5NeFRA3pZMpz6MR4H4YZ3MJM4fvNPnRKeXR1Td2vQGgjorNXfo94WvT5CYDsPAqjHxSn436G1Eu'),
    ...
    def test_sending_offline_hd_multisig_online_addr_p2sh(self, mock_save_db):
        ...
        # create unsigned tx
        outputs = [PartialTxOutput.from_address_and_value(
            'QNZAXJAcoxb5ZBftHaEgFdcAYEGo81An8z', 2500000)]
        tx = wallet_online.mktx(outputs=outputs, password=None, fee=5000)
        tx.set_rbf(True)
        tx.locktime = 1325503
        tx.version = 1
    ...
    def test_sending_offline_hd_multisig_online_addr_p2wsh_p2sh(self, mock_save_db):
        ...
        # create unsigned tx
        outputs = [PartialTxOutput.from_address_and_value(
            'QbZeRSpCc8KHiuGZFYKMdyimwxQttFDEYp', 2500000)]
        tx = wallet_online.mktx(outputs=outputs, password=None, fee=5000)
        tx.set_rbf(True)
        tx.locktime = 1325504
        tx.version = 1
    ...
    def test_sending_offline_hd_multisig_online_addr_p2wsh(self, mock_save_db):
        ...
        wallet_online = WalletIntegrityHelper.create_imported_wallet(
            privkeys=False, config=self.config)
        wallet_online.import_address(
            'tltc1q83p6eqxkuvq4eumcha46crpzg4nj84s9p0hnynkxg8nhvfzqcc7q26lnr9')
        ...
        # create unsigned tx
        outputs = [PartialTxOutput.from_address_and_value(
            'QTAKcyzh2zCA7XY1x1AEThtCjuNctXioJ9', 2500000)]
        tx = wallet_online.mktx(outputs=outputs, password=None, fee=5000)
        tx.set_rbf(True)
        tx.locktime = 1325505
        tx.version = 1
...
class TestWalletHistory_EvilGapLimit(TestCaseForTestnet):
    ...
    def setUp(self):
        ...
        self.config = SimpleConfig({
            ...
            # needed for Synchronizer to generate new addresses without SPV
...
class TestImportedWallet(TestCaseForTestnet):
    ...
    def test_importing_and_deleting_addresses(self, mock_save_db):
        ...
        w.add_transaction(Transaction(
            self.transactions["0e350564ee7ed4ffce24a998b538f7f3ebbab6fcb4bb331f8bb6b9d86d86fcd8"]))
        w.add_transaction(Transaction(
            self.transactions["54de13f7ee4853dc1a281c0e7132efb95330f7ceebc1dbce76fdf34c28028f14"]))
        self.assertEqual(0, sum(w.get_balance()))

        with self.assertRaises(UnrelatedTransactionException):
            w.add_transaction(Transaction(
                self.transactions["314385a9f24457098de9fe5cb3893cc408b9f66085268457b82050c988c97908"]))
        ...
        self.assertTrue(
            "cannot delete last remaining address" in ctx.exception.args[0])
